...
class Emprestimo:
    def __init__(self, conta, valor, parcelas):
        ...
        self._parcelas_restantes = self._parcelas
        self._conta._emprestimos.append(self)
    ...
    def pagar_parcela(self):
        if self._parcelas_restantes != 0:
            ...
            print(f'Empréstimo quitado')

    def __str__(self):
        print(f'Emprestimos da conta {self._conta}')
        return f'Valor total à pagar: {self._valor} | Nº de parcelas: {self._parcelas}'
